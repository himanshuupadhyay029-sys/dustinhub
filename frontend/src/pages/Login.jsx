      ...
      <div className="w-full max-w-md glass p-8 md:p-10 rounded-2xl shadow-2xl relative z-10 border border-white/5">
        ...
        <div className="mt-8 text-center text-sm text-netflix-textGray space-y-4">
          <div>
            ...
            <Link to="/signup" className="text-white hover:text-cinema-red font-bold underline transition duration-200">
              Sign up now
            </Link>
          </div>
          <div className="pt-3 border-t border-white/5">
            <Link to="/admin/login" className="text-netflix-textGray hover:text-cinema-red text-xs font-bold transition duration-200 uppercase tracking-wider">
